...
class Complaint(Base):
    ...
    petitioner_gender = Column(Text, nullable=True)
    transfer_status = Column(Text, nullable=True)
    urgent = Column(Text, nullable=True)
    ...
    self_assign = Column(Text, nullable=True)
    resolved_on = Column(DateTime, nullable=True)
    benefitted = Column(Text, nullable=True)
