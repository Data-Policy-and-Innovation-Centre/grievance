...
\begin{itemize}
    ...
    \item \textbf{Building \& Construction} shows a declining trend (2.10\% in FY2023 $\rightarrow$ 0.58\% in FY2024), possibly indicating improved service delivery or reduced construction activity.
    ...
    \item \textbf{Driving Licences} remains consistently low ($\sim$0.04--0.05\%), indicating relatively smooth service delivery for this category.
\end{itemize}
